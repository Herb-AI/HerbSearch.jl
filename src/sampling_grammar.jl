...
"""
    rand(::Type{RuleNode}, grammar::AbstractGrammar, max_depth::Integer=10)

Generates a random [`RuleNode`](@ref) of arbitrary type and maximum depth max_depth.
"""
function Base.rand(::Type{RuleNode}, grammar::AbstractGrammar, max_depth::Integer=10)
...
"""
    rand(::Type{RuleNode}, grammar::AbstractGrammar, typ::Symbol, max_depth::Integer=10)

Generates a random [`RuleNode`](@ref) of return type typ and maximum depth max_depth.
"""
function Base.rand(::Type{RuleNode}, grammar::AbstractGrammar, typ::Symbol, max_depth::Integer=10)
    dmap = mindepth_map(grammar)
...
"""
    rand(::Type{RuleNode}, grammar::AbstractGrammar, typ::Symbol, dmap::Vector{<:Integer}, max_depth::Integer=10)
...
"""
function Base.rand(::Type{RuleNode}, grammar::AbstractGrammar, typ::Symbol, dmap::Vector{<:Integer}, 
...
"""
    sample(root::RuleNode, typ::Symbol, grammar::AbstractGrammar, maxdepth::Integer=typemax(Int))

Uniformly samples a random node from the tree limited to maxdepth.
"""
function StatsBase.sample(root::RuleNode, maxdepth::Integer=typemax(Int))
...
function _sample(node::RuleNode, x::RuleNodeAndCount, maxdepth::Integer)
    maxdepth < 1 && return
    x.cnt += 1
    if rand() <= 1/x.cnt
        x.node = node
...
"""
    sample(::Type{NodeLoc}, root::RuleNode, maxdepth::Integer=typemax(Int))
...
"""
function StatsBase.sample(::Type{NodeLoc}, root::RuleNode, maxdepth::Integer=typemax(Int))
...
function _sample(::Type{NodeLoc}, node::RuleNode, x::NodeLocAndCount, maxdepth::Integer)
    maxdepth < 1 && return
...
"""
    StatsBase.sample(::Type{NodeLoc}, root::RuleNode, typ::Symbol, grammar::AbstractGrammar, maxdepth::Integer=typemax(Int))
...
"""
function StatsBase.sample(::Type{NodeLoc}, root::RuleNode, typ::Symbol, grammar::AbstractGrammar, maxdepth::Integer=typemax(Int))
...
function _sample(::Type{NodeLoc}, node::RuleNode, typ::Symbol, grammar::AbstractGrammar, x::NodeLocAndCount, maxdepth::Integer)
    maxdepth < 1 && return
    for (j,child) in enumerate(node.children)

...
"""
    get_mh_enumerator(examples::Array{<:IOExample}, cost_function::Function, evaluation_function::Function=HerbInterpret.execute_on_input)
...
"""
function get_mh_enumerator(examples::Array{<:IOExample}, cost_function::Function, evaluation_function::Function=HerbInterpret.execute_on_input)
...
"""
    get_vlsn_enumerator(examples, cost_function, enumeration_depth = 2, evaluation_function::Function=HerbInterpret.execute_on_input)
...
The temperature value of the algorithm remains constant over time. 
"""
function get_vlsn_enumerator(examples, cost_function, enumeration_depth = 2, evaluation_function::Function=HerbInterpret.execute_on_input)
    return (grammar, max_depth, max_size, start_symbol) -> begin
        return StochasticSearchEnumerator(
            grammar=grammar,
            examples=examples,
...
"""
    get_sa_enumerator(examples, cost_function, initial_temperature=1, temperature_decreasing_factor = 0.99, evaluation_function::Function=HerbInterpret.execute_on_input)
...
"""
function get_sa_enumerator(examples, cost_function, initial_temperature=1, temperature_decreasing_factor = 0.99, evaluation_function::Function=HerbInterpret.execute_on_input)
    return (grammar, max_depth, max_size, start_symbol) -> begin
        return StochasticSearchEnumerator(
            grammar=grammar,
            examples=examples,

...
"""
function heuristic_leftmost_fixed_shaped_hole(
        node::AbstractRuleNode, max_depth::Int)::Union{ExpandFailureReason, HoleReference}
    function leftmost(node::AbstractRuleNode, max_depth::Int,
            path::Vector{Int})::Union{ExpandFailureReason, HoleReference}
        if max_depth == 0
    ...
    function leftmost(hole::UniformHole, max_depth::Int,
            path::Vector{Int})::Union{ExpandFailureReason, HoleReference}
        if max_depth == 0
            return limit_reached
        end
...
function heuristic_leftmost(
    ...
    function leftmost(hole::Hole, max_depth::Int,
            path::Vector{Int})::Union{ExpandFailureReason, HoleReference}
        if max_depth == 0
            return limit_reached
        end
...
"""
function heuristic_rightmost(
        node::AbstractRuleNode, max_depth::Int)::Union{ExpandFailureReason, HoleReference}
    function rightmost(node::AbstractRuleNode, max_depth::Int,
            path::Vector{Int})::Union{ExpandFailureReason, HoleReference}
        if max_depth == 0
            return limit_reached
        end
    ...
    function rightmost(hole::Hole, max_depth::Int,
            path::Vector{Int})::Union{ExpandFailureReason, HoleReference}
        if max_depth == 0
            return limit_reached
        end
...
"""
function heuristic_random(
        node::AbstractRuleNode, max_depth::Int)::Union{ExpandFailureReason, HoleReference}
    function random(node::AbstractRuleNode, max_depth::Int,
            path::Vector{Int})::Union{ExpandFailureReason, HoleReference}
        if max_depth == 0
            return limit_reached
        end
    ...
    function random(hole::Hole, max_depth::Int,
            path::Vector{Int})::Union{ExpandFailureReason, HoleReference}
        if max_depth == 0
            return limit_reached
        end
...
"""
function heuristic_smallest_domain(
        node::AbstractRuleNode, max_depth::Int)::Union{ExpandFailureReason, HoleReference}
    function smallest_domain(node::AbstractRuleNode, max_depth::Int,
            path::Vector{Int})::Union{ExpandFailureReason, HoleReference}
        if max_depth == 0
            return limit_reached
        end
        ...
        if isnothing(smallest_result)
            return already_complete
        end
        return smallest_result
    end

    function smallest_domain(hole::Hole, max_depth::Int,
            path::Vector{Int})::Union{ExpandFailureReason, HoleReference}
        if max_depth == 0
            return limit_reached
        end

...
# results = HerbInterpret.evaluate_program(rulenode, problem.examples, grammar, HerbInterpret.execute_on_input)
# println(results)
...
#   output = execute_on_input(symboltable, program, example.in)

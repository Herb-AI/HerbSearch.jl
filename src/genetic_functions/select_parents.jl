...
"""
function select_fitness_proportional_parents(population::Array{RuleNode},
        fitness_array::Array{<:Real})::Tuple{RuleNode, RuleNode}
...
function select_chromosome(
        population::Array{RuleNode}, fitness_array::Array{<:Real})::RuleNode
    random_number = rand()

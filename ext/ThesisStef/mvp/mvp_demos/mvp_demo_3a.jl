...
Iteration:       2               Best score: 40          Best property: suffixof_cvc(concat_cvc(at_cvc(_arg_2, 1), "."), _arg_out)
Iteration:       2               Best cost:  0           Best outputs:  ["Nancy  Nancy", "Andrew  Andrew", "Jan  Jan", "Mariya  Mariya"]

Iteration:       3               Best score: 40          Best property: suffixof_cvc(concat_cvc(at_cvc(_arg_2, len_cvc(" ")), "."), _arg_out)
Iteration:       3               Best cost:  4           Best outputs:  ["Nancy  Nancy", "Andrew  Andrew", "Jan  Jan", "Mariya  Mariya"]

Iteration:       4               Best score: 40          Best property: suffixof_cvc(concat_cvc(at_cvc(_arg_2, len_cvc(".")), "."), _arg_out)
Iteration:       4               Best cost:  8           Best outputs:  ["Nancy  Nancy", "Andrew  Andrew", "Jan  Jan", "Mariya  Mariya"]

Iteration:       5               Best score: 40          Best property: suffixof_cvc(concat_cvc(substr_cvc(_arg_2, 1, 1), "."), _arg_out)
Iteration:       5               Best cost:  12          Best outputs:  ["Nancy  Nancy", "Andrew  Andrew", "Jan  Jan", "Mariya  Mariya"]

Iteration:       6               Best score: 40          Best property: prefixof_cvc(at_cvc(concat_cvc(" ", _arg_out), len_cvc(_arg_out)), _arg_2)
Iteration:       6               Best cost:  16          Best outputs:  ["Nancy  Nancy", "Andrew  Andrew", "Jan  Jan", "Mariya  Mariya"]

Iteration:       7               Best score: 37          Best property: suffixof_cvc(at_cvc(_arg_2, indexof_cvc(_arg_out, ".", 0)), _arg_2)
Iteration:       7               Best cost:  15          Best outputs:  ["Nancy Nancy Fre.", "Andrew Andrew .", "Jan Jan K.", "Mariya Mariya Se."]

Iteration:       8               Best score: 37          Best property: prefixof_cvc(_arg_out, replace_cvc(_arg_out, at_cvc(_arg_2, 1), _arg_2))
Iteration:       8               Best cost:  18          Best outputs:  ["Nancy Fre.", "Andrew .", "Jan K.", "Mariya Se."]

Iteration:       9               Best score: 40          Best property: prefixof_cvc(_arg_1, at_cvc(_arg_2, len_cvc(_arg_out)))
Iteration:       9               Best cost:  20          Best outputs:  ["Nancy  . Fr.", "Andrew  . Ce.", "Jan  . Ko.", "Mariya  . Se."]

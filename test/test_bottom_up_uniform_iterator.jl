@testset verbose=true "Bottom-up iterator" begin
    @testset "smallest element in a tuple" begin
        ...
        iterator = BUUniformIterator(g, :intExpr, problem)
    ...
    @testset "2x + 1" begin
        ...
        iterator = BUUniformIterator(g, :Number, problem)
    ...
    @testset "Arithmetic grammar with constraints" begin
        ...
        programs = collect(BUUniformIterator(grammar, :Number, problem, max_depth=2))

...
using .RefactorExt: convert_subtrees_to_json, parse_number, parse_tree, enumerate_subtrees, parse_json
...
@testset verbose=true "Parse Input Class" begin
    ...
    @testset verbose=true "Parse JSON" begin
        ...
        output1, _ = (parse_json(convert_subtrees_to_json(subtree_set, test_ast1)))
        ...
        subtree_set = vcat(subtree_set, subtrees)
        subtree_set = unique(subtree_set)
        output2, _ = (parse_json(convert_subtrees_to_json(subtree_set, test_ast2)))
